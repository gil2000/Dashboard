...
@section('content')
    <div class="d-flex justify-content-between">
        <h1 class="mb-5">Soil Temperature</h1>
    ...
    <div class="row mt-5">
        <div class="col-md-6 mt-1">
            <div class="card text-dark mb-3 shadow border border-1 border-dark">
                <h5 class="card-header">Average Soil Temperature</h5>
                <div class="card-body">
        ...
        <div class="col-md-6 mt-1">
            <div class="card text-dark mb-3 shadow border border-1 border-dark">
                <h5 class="card-header">Soil Temperature Range</h5>
                <div class="card-body">
    ...
    @push('scripts1')
        <script>
            ...
            var options = {
                ...
                colors: ['#f14040', '#89a7e8', '#ebf140', '#a5ea3a'],
                stroke: {
